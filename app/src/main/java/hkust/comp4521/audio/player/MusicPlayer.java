...
import hkust.comp4521.audio.Constants;
import hkust.comp4521.audio.MusicController;
import hkust.comp4521.audio.R;
...
public class MusicPlayer extends Observable {
    ...
    private	void saveSongInfo(long index)	{
        ...
        // Uri baseUri	= ContentUris.withAppendedId(MediaStore.Audio.Media.INTERNAL_CONTENT_URI, index);
        ...
        if (musiccursor.moveToFirst()) {
            ...
            music_column_index =
                    musiccursor.getColumnIndexOrThrow(MediaStore.Audio.Media.ARTIST);
            mSongTitle += (" - " + musiccursor.getString(music_column_index));
            //	get	the	file	handle
            music_column_index =
        ...
        String[]	projectionImages	=	new	String[]	{	MediaStore.Audio.Albums._ID,
                MediaStore.Audio.Albums.ALBUM_ART};
        Cursor	c	=
                mContext.getContentResolver().query(MediaStore.Audio.Albums.EXTERNAL_CONTENT_URI,
                        projectionImages,
        ...
        if	(c.moveToFirst())	{
            ...
            c.close();
            if	(coverPath	==	null)	{
                coverPath	=	"android.resource://hkust.comp4521.audio/" +
    ...
    private	void	restoreSongInfo()	{
        ...
        albumUri	=	prefs.getString("Album Art",
                "android.resource://hkust.comp4521.audio/"+	R.drawable.note_blue);
    }
